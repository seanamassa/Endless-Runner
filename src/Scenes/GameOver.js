class GameOver extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(centerX, centerY - 200, 'manga', 'GAME OVER', 72).setOrigin(0.5).setTint(0xff0000)
        this.add.bitmapText(centerX, centerY + 100, 'manga', 'PRESS SPACE TO RESTART', 24).setOrigin(0.5)
        this.add.bitmapText(centerX, centerY + 200, 'manga', 'PRESS UP ARROW TO RETURN TO MENU', 24).setOrigin(0.5);
